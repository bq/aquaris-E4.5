...
/* For Ubuntu (audio) should follow the default used by Pulse, which is max 9 */
/* The following entries are the ones used by the Audio HAL */
#define RTPM_PRIO_AUDIO_I2S                 REG_RT_PRIO(6)
#define RTPM_PRIO_AUDIO_CCCI_THREAD         REG_RT_PRIO(7)
#define RTPM_PRIO_AUDIO_RECORD              REG_RT_PRIO(8)
...
//#define RTPM_PRIO_AUDIO_CCCI_THREAD         REG_RT_PRIO(RTPM_PRIO_MM_GROUP_I+2) // Used by Ubuntu
...
//#define RTPM_PRIO_AUDIO_I2S                 REG_RT_PRIO(RTPM_PRIO_MM_GROUP_I+0) // Used by Ubuntu
...
//#define RTPM_PRIO_AUDIO_RECORD              REG_RT_PRIO(RTPM_PRIO_MM_GROUP_H+6) // Used by Ubuntu
