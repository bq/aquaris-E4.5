...
#define MC3XXX_DEV_DRIVER_VERSION              "2.2.0-CKT-TestCode-20150330-1120"
...
#define gsensor_filter(last_data, data)		((( 95* (last_data)) + (5 * (data))) / 100)
...
static void MC3XXX_SetSampleRate(struct i2c_client *pt_i2c_client)
{
    ...
    //Louis, 2915.03.30, try to improve too sensitive to vibrator.
    _baDataBuf[1] = 0x0A;
