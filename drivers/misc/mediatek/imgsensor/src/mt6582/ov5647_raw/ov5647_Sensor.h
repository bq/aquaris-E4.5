...
#define OV5647_IMAGE_SENSOR_PV_WIDTH           (1280 - 24) /* 1256 */
#define OV5647_IMAGE_SENSOR_PV_HEIGHT          (960 - 18) /* 942 */
#define OV5647_IMAGE_SENSOR_VIDEO_WIDTH        (1280 - 24) /* 1256 */
#define OV5647_IMAGE_SENSOR_VIDEO_HEIGHT       (960 - 18) /* 942 */
